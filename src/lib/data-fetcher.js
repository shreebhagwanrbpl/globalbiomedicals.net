...
export async function fetchHomeData() {
  return fetchDocCached("websites/globalbiomedicalsnet/pages/home");
}

export async function fetchContactData() {
  return fetchDocCached("websites/globalbiomedicalsnet/pages/contact");
}

export async function fetchServicesData() {
  return fetchDocCached("websites/globalbiomedicalsnet/pages/services");
}

export async function fetchDistrictData(district) {
  if (!district) return null;
  return fetchDocCached(`websites/globalbiomedicalsnet/districts/${district}`);
}
